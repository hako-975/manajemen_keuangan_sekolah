      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="card shadow">
              <div class="card-body">
                <h5><i class="fas fa-fw fa-dollar-sign"></i> Total Keuangan</h5>
                <h6 class="text-muted">Total Keuangan: Rp. <?= number_format($jml_pemasukan - $jml_pengeluaran); ?></h6>
                <a href="laporan.php" class="btn btn-info"><i class="fas fa-fw fa-align-justify"></i></a>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="card shadow">
              <div class="card-body">
                ...
                <h6 class="text-muted">Jumlah Pemasukan: Rp. <?= number_format($jml_pemasukan); ?></h6>
