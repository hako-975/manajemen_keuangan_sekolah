...
function deletePengeluaran($id) {
	...
	if (checkJabatan() == true) {
		$id_user = htmlspecialchars($_SESSION['id_user']);
		$fetch_sql = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM pengeluaran WHERE id_pengeluaran = '$id'"));
		riwayatPengeluaran($id_user, "telah menghapus Pengeluaran " . $fetch_sql['keterangan'] . " dari biaya Rp. " . number_format($fetch_sql['jumlah_pengeluaran']));
...
function deletePemasukan($id) {
	...
	if (checkJabatan() == true) {
		$id_user = htmlspecialchars($_SESSION['id_user']);
		$fetch_sql = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM pemasukan WHERE id_pemasukan = '$id'"));
		riwayatPemasukan($id_user, "telah menghapus Pemasukan " . $fetch_sql['keterangan'] . " dari biaya Rp. " . number_format($fetch_sql['jumlah_pemasukan']));
